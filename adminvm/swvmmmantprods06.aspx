<%@ Page Language="C#" MasterPageFile="~/index.master" AutoEventWireup="true" CodeFile="swvmmmantprods06.aspx.cs" Inherits="swvmmmantprods06" Title="Mantenimiento de Productos - Vivero Market" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphIndex" Runat="Server">
    <table style="width: 763px; top: 150px; height: 34px">
        ...
        <tr>
            ...
            <td style="width: 162px; height: 18px">
                <asp:DropDownList ID="ddlProvid" runat="server" BackColor="#E3F6CE"
                    DataTextField="empresa" Width="150px" DataValueField="provid" Enabled="False">
                </asp:DropDownList></td>
            <td style="width: 137px; height: 18px">
                </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" style="height: 5px">
                <asp:CheckBox ID="chkActImage" runat="server" AutoPostBack="True" Checked="True" OnCheckedChanged="chkActImage_CheckedChanged" Text="No actualizar Imágen" Visible="False" /></td>
        </tr>
        <tr>
            <td style="width: 18px; height: 5px">
            </td>
