/**
 * cvi_corner_lib.js 1.9 (19-Jun-2009) (c) by Christian Effenberger 
...
var cvi_corner = {
	...
	add: function(image, options) {
		if(image.tagName.toUpperCase() == "IMG") {
			var defopts = { "radius" : cvi_corner.defaultRadius, "shadow" : cvi_corner.defaultShadow, "shade" : cvi_corner.defaultShade, "inverse" : cvi_corner.defaultInverse, "filter" : cvi_corner.defaultFilter, "callback" : cvi_corner.defaultCallback }
			if(options) {
